        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: 16 }}>
            ...
            <input
              ...
              style={{ width: '100%', padding: '8px 12px', backgroundColor: 'var(--dc-input-bg)', border: '1px solid var(--dc-input-border)', borderRadius: 6, color: 'var(--dc-input-text)', fontSize: 14, outline: 'none', boxSizing: 'border-box' }}
            />
          </div>
        ...
        {googleEnabled && (
          <>
            ...
            <a
              ...
              style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, width: '100%', padding: '8px 16px', backgroundColor: 'var(--dc-surface)', color: 'var(--dc-text)', fontWeight: 500, borderRadius: 6, border: '1px solid var(--dc-border)', cursor: 'pointer', fontSize: 14, textDecoration: 'none', boxSizing: 'border-box' }}
            >
